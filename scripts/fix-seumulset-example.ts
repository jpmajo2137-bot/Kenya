/**
 * 스물셋 카드 예문 → 스물세 명의 학생이 운동장에 모여서 체육대회를 준비했어요.
 * 발음·TTS·EN/SW (다른 단어/예문은 변경 없음)
 *
 * 사용: npx tsx scripts/fix-seumulset-example.ts
 */
...
const WORD = '스물셋'
const EXAMPLE_NEW = '스물세 명의 학생이 운동장에 모여서 체육대회를 준비했어요.'
const PRON = 'seumulse myeong-ui haksaeng-i undongjang-e moyeoseo cheyukdaehoe-reul junbihasseoyo.'
const EN = 'Twenty-three students gathered on the playground to prepare for the sports day.'
const SW =
  'Wanafunzi ishirini na watatu walikusanyika uwanjani wa michezo kuandaa mashindano ya michezo.'
