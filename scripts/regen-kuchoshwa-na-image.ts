/**
 * kuchoshwa na (~하는 데 질리다 / be sick of, be tired of) 단어 이미지 재생성 (gpt-image-1)
 * 모든 모드 행에 동일 URL 적용
 *
 * 사용법: npx tsx scripts/regen-kuchoshwa-na-image.ts
 */
...
const WORD = 'kuchoshwa na'
const SLUG = 'kuchoshwa-na'
const PROMPT = `A simple, clean educational illustration for "to be sick of" / "to be tired of" something (Swahili phrase "kuchoshwa na").
Show a light, relatable scene: a tired person at a simple desk with a long paper stack, OR a small line of cars suggesting traffic — mild frustration, not angry, cartoon-like and friendly. No gore, no text.
